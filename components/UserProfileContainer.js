...
class UserProfileContainer extends Component{
  ...
  componentWillMount(){
    ...
    if(this.props.dfp.authed){
      this.setState({nickname: this.props.dfp.authed.nickname});
      this.setState({picture: this.props.dfp.authed.picture});
      this.setState({description: this.props.dfp.authed.user_metadata.description});
    }
    else{
  ...
  render(){
    ...
    { return (
      <StrippedContainer header={this.state.nickname}>
        <FlexWrapper>
